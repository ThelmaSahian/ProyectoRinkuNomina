...
namespace RinkuNomina.Infrastructure.Migrations
{
    ...
    [Migration("20230529003829_add-table-BitacoraSueldo-BonosPorRol-Cliente-EntregasPorEmpleado-FrecuenciaBono-SueldoBase-TipoBono-Usuario")]
    partial class addtableBitacoraSueldoBonosPorRolClienteEntregasPorEmpleadoFrecuenciaBonoSueldoBaseTipoBonoUsuario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RinkuNomina.Domain.Model.RolEmpleado", b =>
                {
                    ...
                    b.Property<Guid>("IdUsuarioCreacion2")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("IdUsuarioModificacion2")
                        .HasColumnType("uniqueidentifier");
